...
const Tag: React.FC<TagProps> = ({ name, variant = "default" }) => {
  return (
    <div className="flex flex-row gap-1 items-center w-fit h-fit justify-center uppercase text-[var(--white)] bg-[var(--yellow-bg-transparent)] border border-[var(--yellow-border-transparent)] rounded-[4px] px-1.5 py-1">
