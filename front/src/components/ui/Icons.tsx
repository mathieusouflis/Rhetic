...
export const Icon: React.FC<IconProps> = ({
  ...
  const icons = {
      ...
      >
        ...
        <defs>
          <clipPath id="clip0_10678_10382">
            <rect width={size} height={size} fill={full ? color : "none"} />
          </clipPath>
        </defs>
      </svg>
    ),
    ...
    logo: (
      ...
      >
        <path
          d="M14.6208 26.0793C21.2922 26.0793 26.7004 20.6711 26.7004 13.9997C26.7004 7.3282 21.2922 1.91992 14.6208 1.91992C7.94929 1.91992 2.54102 7.3282 2.54102 13.9997C2.54102 20.6711 7.94929 26.0793 14.6208 26.0793Z"
          stroke={color}
          stroke-width="0.805316"
          stroke-linecap="round"
          stroke-dasharray="5.64 5.64"
        />
        <path
          d="M18.6473 14.0002C18.6473 11.7764 16.8445 9.97363 14.6207 9.97363C12.3969 9.97363 10.5941 11.7764 10.5941 14.0002C10.5941 16.224 12.3969 18.0269 14.6207 18.0269C16.8445 18.0269 18.6473 16.224 18.6473 14.0002Z"
          fill={full ? color : "none"}
        />
      </svg>
    ),
